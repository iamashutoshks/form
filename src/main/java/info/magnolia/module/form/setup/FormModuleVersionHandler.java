...
public class FormModuleVersionHandler extends DefaultModuleVersionHandler {
    ...
    public FormModuleVersionHandler() {
        ...
        register(DeltaBuilder.update("1.4.9", "")
                ...
                .addTask(new NodeExistsDelegateTask("Enable Honeypot in GroupFields", "Add Honeypot to GroupFields available components", "config", "/modules/form/templates/components/formGroupFields/areas/fields/availableComponents/formHoneypot", null, new BootstrapSingleResource("Rebootstrap formGroupFields template", "Add formHoneypot as new available component for formGroupFields.", "/mgnl-bootstrap/form/templates/components/config.modules.form.templates.components.formGroupFields.xml")))
        ...
        register(DeltaBuilder.update("1.4.11", "")
                .addTask(new NodeExistsDelegateTask("Reconfigure Honeypot dialog", "Use 'hidden' controlType for validation field in Honeypot dialog", RepositoryConstants.CONFIG, HONEY_POT_VALIDATION_FIELD_PATH,
                        new ArrayDelegateTask("", "",
                                new SetPropertyTask(RepositoryConstants.CONFIG, HONEY_POT_VALIDATION_FIELD_PATH, "controlType", "hidden"),
                                new MoveAndRenamePropertyTask("Change property name 'value' to 'defaultValue' for validation field in Honeypot dialog", HONEY_POT_VALIDATION_FIELD_PATH, "value", HONEY_POT_VALIDATION_FIELD_PATH, "defaultValue")))));

        register(DeltaBuilder.update("1.4.12", "")
                .addTask(new PropertyExistsDelegateTask("Fix Honeypot dialog", "Set 'defaultValue' for validation field in Honeypot dialog", RepositoryConstants.CONFIG, HONEY_POT_VALIDATION_FIELD_PATH, "defaultValue", null,
