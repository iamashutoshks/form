...
public class DialogStaticWithFormParamsTest extends RepositoryTestCase {
    ...
    public void testFindAllFormControlNames() throws RepositoryException, IOException {
        ...
        Node submit = contentParagraph.addNode("nodeWithFormHoneypotTemplateshouldBeSkipped");
        ...
        childNode.addNode("MetaData").setProperty("mgnl:template", "form:components/formEdit");
        grandChildNode.addNode("MetaData").setProperty("mgnl:template", "form:components/form");
        submit.addNode("MetaData").setProperty("mgnl:template", "form:components/formHoneypot");
